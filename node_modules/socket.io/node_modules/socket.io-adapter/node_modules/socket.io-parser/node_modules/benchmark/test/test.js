    ...
    (function () {
        ...
        test('clones objects with custom descriptors and circular references', function () {
            ...
            if (support.descriptors) {
                ...
                (descriptor = getDescriptor(clone.foo.b, 'foo')) && !(descriptor.configurable && descriptor.enumerable && descriptor.writable) &&
                (descriptor = getDescriptor(clone, 'bar')) && !(descriptor.configurable && descriptor.enumerable && descriptor.writable));
            }
            else {
                skipTest(1)
            }
    ...
    (function () {
        ...
        forOwn(objects, function (object, key) {
            ...
            test('produces an array of the correct length for sparse ' + key + 's', function () {
                equal(Benchmark.map(object, function () {
                }).length, 5);
            });
        });
    }());
